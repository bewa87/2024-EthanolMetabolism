...
subplot(3,1,1);
plot(t(1:2:end),B_NSFDM(1:2:end),'linewidth',1.25);
...
subplot(3,1,2);
plot(t(1:2:end),B_EE(1:2:end),'linewidth',1.25);
title('Amount of ethanol in blood (EE)');
xlabel('t');
ylabel('B(t)');
yticks([-1.2 -0.8 -0.4 0 0.4]);

subplot(3,1,3);
plot(t(1:2:end),B_RK2(1:2:end),'linewidth',1.25);
